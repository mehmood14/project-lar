                    ...
                    <div class=" p-5">
                        ...
                        <form action="/examples/actions/confirmation.php" class="needs-validation" method="post" novalidate>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputText" placeholder="Username" required>
                                <div class="invalid-feedback">Please enter your name to continue.</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="button">
                                <button type="submit" class="btn btn-default btn-lg btn-block">SIGN UP</button></br>
                            </div>
                            ...
                            <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="/signin" class="text-primary">Login</a>
                            </div>
